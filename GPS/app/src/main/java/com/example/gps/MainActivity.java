...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void stopGPS() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
            ...
            if (lastLocation != null) {
                ...
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(lastKnownLocation, zoom));
            } else {
    ...
    private void gotoPeta(Double lat, Double lng, Float z) {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(LokasiBaru, z));
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(ITS, 17));
    }
}